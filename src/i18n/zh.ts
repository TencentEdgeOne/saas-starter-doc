export default {
  systemTitle: '🚀 EdgeOne Pages Saas 起步模板',
  banner: {
    title: '👋 嘿，欢迎来到 EdgeOne Pages Saas 起步模板!',
    more: '了解详情',
  },
  ...
  featureList: [
    {
      title: '先进的技术栈',
      description:
        '高效的 React (v19) 框架，使用 Next.js、Nextra(v4) 和 Shadcn UI 打造现代化应用',
    },
    {
      title: '国际化支持 (i18n)',
    ...
    },
    {
      title: 'Iconify 图标集',
      description:
        '纯 CSS 图标, 集成 Iconify 图标集，提供丰富的图标选择，增强 UI 视觉表现',
    },
    {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        '可以使用提供的组件库，按照文档中的说明进行自定义和扩展，以适应您的具体需求。',
    },
    {
